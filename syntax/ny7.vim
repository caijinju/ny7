...
syn keyword ariIns adda xora incm decm rrm rlm mvam mvma anda ora suba bclr bset mvrm mvmr mvlr mvla addl subl andl orl xorl inca deca rrc rlc rra rla cpla setc clrc 
" Conditional Instructions
syn keyword conIns jnc jc jnz jz jb sagt salt sane sbz sbnz
" Data Audio Instructions
syn keyword audIns play ldsec ldph rbvpr snp sp sanp stop snhp shp playi ldseci
" Other Instructions
syn keyword othIns ldpr rbdpr rdn rdni rd rdi ldpri call jmp rcall rjmp ret iret halt slow cwdt page0 page1 rbda ldda nop

" syn keyword ny7regD rpt0 rpt1 rpt2 rpt3 rpt4 rpt5 xmd rod1 rod2

" syn keyword ny7regT vol pflg int mix aud pa pb pc pd pe pf
syn keyword ny7SFR prt0 prt1 prt2 prt3 prt4 prt5 envl envh rod1 rod2 charc aud int decmd onoff vol bank xmd chno pa paio pb pbio pc pcio pd pdio pe peio pf pfio
...
"hi def link ny7regD	SpecialKey
"hi def link ny7regT	SpecialKey
hi def link ny7SFR SpecialKey

""""""""""""""""""""""""""""""""""""""""""""""""""

let b:current_syntax = "ny7"
